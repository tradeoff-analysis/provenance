...
<a href=https://hal.inria.fr/hal-03692163/document>
Mehdi Chakhchoukh, Nadia Boukhelifa, Anastasia Bezerianos. Understanding How In-Visualization Provenance Can Support Trade-off Analysis. IEEE Transactions on Visualization and Computer Graphics, Institute of Electrical and Electronics Engineers, 2022, ⟨10.1109/TVCG.2022.3171074⟩. ⟨hal-03692163⟩ </a>
...
We collected video recordings of three case studies (324 minutes). <a href="Study_Protocol.pdf">This</a> document describes the steps we took during the exploration sessions.
Two different authors of this paper independently coded each video using discrete events, then met to discuss annotation codes and resolved conflicts. Our **concordance rate** for the identified provenance events was 71%, and was lower for the high level provenance goals.
